...
const ChannelList: React.FC<ChannelListProps> = ({
    ...
    return (
        <TooltipProvider>
            <div data-tour="tour-channel-list" className="w-52 min-w-52 max-w-60 md:w-60 bg-sidebar-background flex flex-col overflow-hidden border-r border-sidebar-border flex-shrink-0">
                {/* Level Header */}
