...
import {
  ...
  ChevronDown, Sparkles, AlertTriangle, Globe,
} from 'lucide-react';
...
function FindingsReviewTab() {
  ...
  const publishMutation = useMutation({
    mutationFn: async (findingIds: string[]) => {
      // Queue finding IDs for publisher
    ...
    <div className="space-y-4">
      ...
      {isLoading ? (
        ...
        <Card><CardContent className="py-8 text-center text-muted-foreground">
          ...
          <p>No scout findings yet. Run civic-scout to collect intelligence.</p>
        </CardContent></Card>
      ) : (
    ...
    <div className="space-y-4">
      {isLoading ? (
        ...
        <Card><CardContent className="py-8 text-center text-muted-foreground">
          ...
          <p>No auto-generated posts yet. Publish findings from the Findings tab.</p>
        </CardContent></Card>
      ) : (
        <div className="space-y-2">
          {posts.map(post => (
                ...
                <CardContent className="space-y-2">
                  {isEditing ? (
                    ...
                    <div className="space-y-1">
                      ...
                      {t.example_good && (
                        <div className="mt-2">
                          <span className="text-[10px] font-medium text-emerald-600">Good example:</span>
    ...
    <Tabs defaultValue="findings" className="space-y-6">
      <TabsList className="flex-wrap h-auto gap-1">
        <TabsTrigger value="findings" className="gap-2">
          <Search className="w-4 h-4" />Findings Review
        </TabsTrigger>
        <TabsTrigger value="auto-posts" className="gap-2">
          <Bot className="w-4 h-4" />Auto-Generated Posts
        </TabsTrigger>
